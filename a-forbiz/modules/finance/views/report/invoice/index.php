...
<div class="row">
    <div class="col-sm-2">
        <div class="form-group">
            <label>Project</label>
            <select id="projectinvoice" name="projectinvoice" class="form-control form-select2" data-style="btn-white">
    ...
    <div class="col-sm-2">
        <div class="form-group">
            ...
            <select id="actor" name="actor" class="form-control form-select2 actoras" data-style="btn-white" data-placeholder="Choose Supplier & Subcon">
    ...
    <div class="col-sm-2 col-xs-6 hidden-xs">
        ...
        <div class="btn-group btn-group-justified">
            <a onclick="onExport()" class="btn btn-sm btn-dark"><i class="fa fa-download"></i> <span class="mg-l-sm hidden-xs"></span> Excel</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".load_main_data").load("<?php echo base_url() ?>finance/report/invoice/table/" + $("select[name=projectinvoice] option:selected").val() + "/" + $('.startas').val() + "/" + $('.endas').val() + '/' + '<?php echo $mode; ?>');
    });
    ...
    $("#forms").submit(function () {
        ...
        var project = $("select[name=projectinvoice] option:selected").val();
        $(".load_main_data").load("<?php echo base_url() ?>finance/report/invoice/table/" + project + "/" + starts + "/" + ends + '/' + '<?php echo $mode; ?>' + '/' + actors);
        return false;
    });
    ...
    function onExport() {
        ...
        window.open("<?php echo base_url('finance/report/export/invoice'); ?>" + '/' + project + '/' + starts + '/' + ends + '/' + '<?php echo $mode; ?>' + '/' + actors);
    }
</script>