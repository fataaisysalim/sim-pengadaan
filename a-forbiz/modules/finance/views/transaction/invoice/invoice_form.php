...
<section class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <div class="row" style="margin-top: -10px">
            <div class="col-sm-6">
                    ...
                    <div class="col-sm-5">
                        <div class="form-group">
                            ...
                            <div class="input-group mg-b-md">
                                ...
                                <input type="text" name="invoice_project_code" value="<?php echo isset($invoice_id) ? $invoice->project_code : NULL; ?>" class="proCode form-control" placeholder="Kode SPK" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mg-b-md">
                                ...
                                <input type="text" name="invoice_number" value="<?php echo empty($invoice_id) ? set_value('invoice_number') : $invoice->invoice_number; ?>" class="form-control" placeholder="Nomor Invoice">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mg-b-md">
                                <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                                <input type="text" name="invoice_tax_serial" value="<?php echo empty($invoice_id) ? set_value('invoice_tax_serial') : $invoice->invoice_tax_serial; ?>" class="form-control" placeholder="Kode Faktur">
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 mg-b-sm">
                        <div class="form-group">
                            <label id="actor_label">Nama Supplier</label>
                            <div id="select_actor">
                                <select disabled id="actor" name="actor" onchange="getActData()" class="form-control form-select2" data-style="btn-white" data-placeholder="Pilih Supplier/Subcon">
                                    <option value=""></option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group">
                            <label id="actor_code_label">Kode Nasabah</label>
                            <div class="input-group mg-b-md">
                                <span class="input-group-addon"><i class="fa fa-truck"></i></span>
                                <input type="text" class="codeAct form-control" value="<?php echo isset($invoice_id) ? $invoice->actor_code : NULL; ?>" placeholder="Kode Nasabah" readonly/>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-7">
            ...
            <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <table class="table" style="width: 100%; border: none; margin-right: 5px; margin-left: 5px;">
                            <tr>
                                <td style="padding: 0 0 10px 0; border: none;" width="50%"><b>Tanggal Terima Invoice</b></td>
                            ...
                            <tr>
                                ...
                                <td style="padding: 10px 0 10px 0; border: none;" width="5%"><b> : </b></td>
                                <td style="padding: 10px 0 0 0; border: none;"><?php echo ucwords($sess['users']->users_position_name) ?></td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select id="project" onchange="getProData()" name="project" class="form-control form-select2" data-style="btn-white" data-placeholder="Nomor SPB">
                                <option value=""></option>
                                <option value="1">SPB123</option>
                                <?php //foreach ($project as $pro) : ?>
                                    <!-- <option value="<?php echo $pro->project_id; ?>" <?php if (isset($invoice_id) && $pro->project_id == $invoice->project_id) echo "selected"; ?> <?php //if ($pro->project_id == set_value('project')) echo "selected"; ?>><?php echo ucwords($pro->project_name); ?></option> -->
                                <?php //endforeach; ?>
                            </select>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group"> 
                            <label style="margin: 0 5px;">Tanggal Invoice</label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label style="margin: 0 5px;">Tanggal Proyek</label>
                ...
                <div class="row">
                    <div class="col-sm-12" style="margin-right: 5px; margin-left: 5px;">
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="30" class="form-control" placeholder="Deskripsi Max 30 Karakter" name="invoice_note" value="<?php echo isset($invoice_id) ? $invoice->invoice_note : NULL; ?>"/>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 row_count">
                <table class="table" style="margin-right: 5px; margin-left: 5px;">
                    <tr>
                ...
                <div class="row">
                    <?php if (!empty($invoice_id)) { ?>
                        <div class="<?php echo!empty($invoice_id) ? 'col-xs-6' : null ?>">
                            <a href="<?php echo base_url('finance/invoice'); ?>" role="button" style="cursor: pointer" class="cancel_m btn btn-danger col-xs-12"><i class="fa fa-times mg-r-sm"></i> Cancel </a>
                        </div>
<?php } ?>
                    <div class="<?php echo!empty($invoice_id) ? 'col-xs-6' : 'col-md-12 col-sm-12 col-xs-12' ?> pull-right">
                        <button disabled type="submit" class="btn btn-block btn-primary" id="save"><i class="fa fa-check mg-r-sm"></i> Save</button>
                    </div>
                </div>
            </div>
...
<?php if (isset($invoice_id)) : ?> 
            $("#select_actor").load("<?php echo base_url("$url/vendor") ?><?php echo isset($invoice_id) ? "/$invoice->invoice_resource_code/" . md5($invoice->actor_id) : NULL; ?>");
            $("#taxs").load("<?php echo base_url("$url/get-tax"); ?>/" + $("input[name=invoice_ct]:checked").val() + "/" + $("input[name=invoice_resource_code]:checked").val() + "/<?php echo isset($invoice_id) ? $invoice_id : NULL; ?>");
...
<?php endif; ?>
        ...
        $(".cancel_m").click(function() {
            $(".mtform").load("<?php echo base_url("$url/form") ?>");
        });
        ...
        $(".resource").change(function(){
            ...
            if($("input[name=invoice_resource_code]:checked").val() == 1) {
                ...
                $("#form").attr('action', "<?php echo base_url("$url/save/subcon"); ?>");
                $("#actor_label").html('Subkon');
                $("#actor_code_label").html('Subkon Code');
            } 
            $("#select_actor").load("<?php echo base_url("$url/vendor") ?>/" + $("input[name=invoice_resource_code]:checked").val());
        });
        ...
        $(".invoice_ct").change(function(){
            if($("input[name=invoice_ct]:checked").val() != 3) {
                ...
                $("#taxs").load("<?php echo base_url("$url/get-tax"); ?>/" + $("input[name=invoice_ct]:checked").val() + "/" + $("input[name=invoice_resource_code]:checked").val());
    ...
    function get_btn() {
        if($("#actor").val() != '' && $("#project").val() != '') {
            ...
            $('.row_detail').html('');
            if($("input[name=invoice_resource_code]:checked").val() == 1) {
                $(".row_detail").load("<?php echo base_url("$url/data-include"); ?>/" + $("input[name=invoice_resource_code]:checked").val() + "/" + $("#actor").val() + "/" + $("#project").val() + "<?php echo isset($invoice_id) ? '/' . md5($invoice->invoice_id) : NULL; ?>");
            ...
            $(".row_count").load("<?php echo base_url("$url/count"); ?>/" + $("input[name=invoice_resource_code]:checked").val() + "<?php echo isset($invoice_id) ? '/' . md5($invoice->invoice_id) : NULL; ?>");
        }
    }
    ...
    function adds_row() {
        ...
        var baris = '<tr class="row_out row_tam">'
            ...
            + '<td style="border: none;" colspan="1" id="transaction_select_' + counter + '"></td>'
            + '<td style="border: none;" ></td>'
            + '<td style="border: none;" rowspan="2" class="text-center"><button type="button" class="btn btn-danger" id="btn_' + counter + '" onclick="cut(this, ' + counter + ')"><i class="fa fa-times"></i></button></td>'
            + '</tr><tr class="note_row_' + counter + '">'
            + '<td class="hidden-xs" colspan="2">'
            + '<table class="table" style="border: none;">'
            + '<thead class="bg-dark" style="color: white">'
            + '<tr>'
            + '<th class="text-center hidden-xs" style="min-width: 30px; padding: 15px">No.</th>'
            + '<th class="text-center hidden-xs" style="min-width: 170px; padding: 15px">Material</th>'
            + '<th class="text-center hidden-xs" style="min-width: 30px; padding: 15px">Code</th>'
            + '<th class="text-center hidden-xs" style="min-width: 30px; padding: 15px">Unit</th>'
            + '<th class="text-center hidden-xs" style="min-width: 30px; padding: 15px">Convertion</th>'
            + '<th class="text-center hidden-xs" style="min-width: 30px; padding: 15px">Volume</th>'
            + '<th class="text-center hidden-xs" style="min-width: 130px; padding: 15px">Price</th>'
            + '<th class="text-center hidden-xs" style="min-width: 130px; padding: 15px">Subtotal</th>'
            + '</tr>'
        ...
        $('#transaction_select_' + counter).load("<?php echo base_url("$url/data-display") ?>/" + counter + "/" + $("#actor").val() + "/" + $("#project").val() + "/" + $("input[name=invoice_resource_code]:checked").val());
    }
    ...
    function adds_equipt() {
        ...
        var baris = '<tr class="row_out row_tam">'
            ...
            + '</td>'
            + '<td>'
            + '<input type="text" onkeyup="total_equipt(this)" name="invoice_dt_total[]" id="invoice_dt_total_' + counter + '" value="" class="form-control text-right">'
            + '</td>'
            ...
            + '</tr>';
        $('#show_row').append(baris);
        $('#select_equipment_' + counter).load("<?php echo base_url("$url/data-equipment"); ?>/" + counter + "/" + $("#actor").val() + "/" + $("#project").val() + "/" + $("input[name=invoice_resource_code]:checked").val());
    }

    function get_transaction_detail(a, i, resource) {
        $("#show_dt_" + i).load("<?php echo base_url("$url/transaction-detail"); ?>/" + a.value + "/" + i + '/' + resource);
    }
    
    function getActData() {
        $.ajax({
            url: "<?php echo base_url("$url/vendor-data"); ?>/" + $('#actor').val(),
            dataType: "JSON",
    ...
    function get_detail(el) {
        $.ajax({
            url: "<?php echo base_url("$url/bapb"); ?>/" + el.value,
            dataType: "JSON",
            success: function(json) {
                if (json.status == 1) {
                    ...
                    $('#show_row').load("<?php echo base_url("$url/bapb/detail"); ?>/" + el.value);
                }
            }
        });
        return false;
    ...
    function getProData() {
        $.ajax({
            url: "<?php echo base_url("$url/project"); ?>/" + $('#project').val(),
            dataType: "JSON",
            success: function(json) {
                if (json.status == 1) {
    ...
    $("#form").submit(function() {
        ...
        if ($("input[name=invoice_number]").val() == "") {
            bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>Nomor Invoice can not empty");
            $("input[name=invoice_number]").focus();
            return false;
        }
        if ($("input[name=invoice_netto]").val() == "") {
            bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>Netto can not empty");
            $("input[name=invoice_netto]").focus();
            return false;
        }
        if ($("input[name=invoice_date_kwt]").val() == "") {
            bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>Invoice date can not empty");
            $("input[name=invoice_date_kwt]").focus();
            return false;
        }
        
        if ($("input[name=invoice_date_pry]").val() == "") {
            bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>Project date can not empty");
            $("input[name=invoice_date_pry]").focus();
            return false;
        }
        if ($("input[name=invoice_tax_serial]").val() == "") {
            bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>Invoice number can not empty");
            $("input[name=invoice_age]").focus();
            return false;
        }
        if ($("select[name=actor] option:selected").val() == "") {
            bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>Vendor can not empty");
...
<?php if (!isset($invoice_id)) { ?> 
            if(min) {
                if (min > currencyToNumber($("#percent_netto").val())) {
                    bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>Progress value should not be less or equal to the previous progress. Previous progress value is " + min + "%");
...
<?php } ?>
        ...
        if($("#percent_netto").val()) {
            if (currencyToNumber($("#percent_netto").val()) > 100) {
                bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>Progress value should not be more than 100");
                $("input[name=percent_netto]").focus();
                return false;
            }
        }
        ...
        for (var e = 1; e <= jmlTransM; e++) {
            if($("input[name=invoice_resource_code]:checked").val() == 1) {
                ...
                if (mog == '') {
                    bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>BAPP can not empty");
                    return false;
                }
            } else if ($("input[name=invoice_resource_code]:checked").val() == 2) { 
                ...
                if (equ == '') {
                    ...
                    if(tagihan > debt) {
                        bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>The invoice nominal should not be more than the rest of the debt. The remaining debt is " + numberToCurrency(debt));
                        return false;
                    }
                }
            }
        ...
        $.ajax({
            ...
            success: function(json) {
                if (json.status == 0) {
                    ...
                    window.open("<?php echo base_url("finance/invoice-receipt") ?>/" + json.id);
