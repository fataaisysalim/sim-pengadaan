...
<section class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <?php } ?>
        <input type="hidden" name="jenis_procurement" id="jenis_procurement" value="pengadaan"/>
        <input type="hidden" name="jenis" id="jenis_procurement" value="pengadaan"/>
            ...
            <div class="col-sm-12">
                ...
                <div class="col-xs-3">
                    <div class="form-group">
                        <label>Tanggal <span id="label_tanggal">Pengadaan</span></label>
                        <div class="input-group mg-b-md">
                            <input type="text" class="datepicker form-control" name="tanggal" id="tanggal" value="<?php echo isset($row->tanggal_spb) ? $row->tanggal_spb : NULL; ?>">
                        </div>
                    </div>
                </div>
            ...
            <div class="pengajuan_tampil">
                    ...
                    <div class="col-xs-3 mg-b-md">
                        <div class="form-group">
                            ...
                            <input type="text" name="tanggal_kirim" class="datepicker form-control" value="<?php echo isset($row->tanggal_kirim) ? $row->tanggal_kirim : NULL; ?>" placeholder="Tanggal Pengiriman"/>
                        </div>
                    </div>
                    <?php if($sess['users']->users_jenis=='Pusat') : ?>
                    <div class="col-xs-2 mg-b-md">
                        <div class="form-group">
                            <label>No Kontrak</label>
                            <div class="form-group">
                                <!-- <span class="input-group-addon"><i class="fa fa-truck"></i></span> -->
                                <input type="text" name="no_kontrak" class="form-control" value="" placeholder="No Kontrak" />
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
                        ...
                        <tbody id="show_row">
                         ...
                         <tr>
                            ...
                            <?php if($role_id!=15) { ?>
                                ...
                                <th>
									<input type="text" class="form-control" name="mog_total" id="mog_total"/>
									<input type="hidden" class="form-control" name="mog_total_h" />
								</th>
                            <?php } ?>
							<?php //} ?>
                        </tr>
            ...
            function adds_row() {
                ...
                var baris = '<tr class="row_out row_tam">'
                    ...
                    $('.get_total').keyup(function(){
                        var max_pengadaan   = 500000000;
                        var mog_total       = $('[name=mog_total_h]').val();
                            mog_total       = parseInt(currencytonum(mog_total));

                        if(max_pengadaan <= mog_total){
                            bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>nominal pengadaan proyek harus di bawah 500.000.000");
              ...
              /*$.ajax({
                ...
                function approved(){
					$('#mog_total').removeAttr("disabled");
                    var spb = $("#no_spb").val()
                    var no_bapb = $("#no_bapb").val()
                    var jenis_procurement = $("#jenis_procurement").val()
					
					bootbox.confirm("Anda Yakin akan Menyetujui data Pengadaan ini?", function(result) {
                            if(result){
                ...
                function get_count(a, i, ct) {
                    ...
                    $("#total_price").val(numberToCurrency2(total));
