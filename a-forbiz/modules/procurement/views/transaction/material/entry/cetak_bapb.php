...
<section class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <div class="row" style="margin-top: -20px">
                ...
                <div class="col-xs-8">
                    <div class="form-group">
                        <label>Berita Acara Penerimaan Barang</label>
                        <div class="input-group mg-b-md">
                           <table border="1" class="table">
                               <tr>
                                   <td>No</td>
                                   <td>:</td>
                                   <td><?php echo isset($row->no_bapb)?$row->no_bapb:""?> / GD / UTR / II / <?php echo date('Y')?></td>
                               </tr>
                               <tr>
                                   <td>Laveransir</td>
                                   <td>:</td>
                               ...
                               <tr>
                                   <td>Surat Jalan</td>
                                   <td>:</td>
                                   <td><?php echo isset($row->no_spb) ? $row->no_spb : NULL; ?></td>
                               </tr>
                           </table>
                        </div>
                    </div>
        ...
        <div class="row">
            <!-- <div class="col-xs-4">
                <div class="form-group">
                    ...
                    <div class="input-group mg-b-md">
                        <?php echo isset($row->no_bapb)?$row->no_bapb:""?>
                    </div>
                </div>
            </div>
            <div class="col-xs-4">
                <div class="form-group">
                    ...
                    <div class="input-group mg-b-md">
                        <?php echo isset($row->nomor_pengajuan)?$row->nomor_pengajuan:""?>
                    </div>
                </div>
            </div>
            <div class="col-xs-4 mg-b-md">
                <div class="form-group">
                    <label>No SPB</label>
                    <div class="input-group mg-b-md">
                        <?php echo isset($row->no_spb) ? $row->no_spb : NULL; ?>
                    </div>
                </div>
            </div> -->
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4 mg-b-md">
                        <div class="form-group">
                            <label>CATATAN</label>
                            <div class="input-group mg-b-md">
                                1-5 & 8 : Diisi oleh Bag. Gudang<br/>
                                    6-7 : Diisi Oleh Bag. KSPP
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
            ...
            function print_pengajuan(){
                $("#print").hide();
                window.print(); 
                window.location.href="<?php echo base_url() ?>procurement/transaction/material/index/all";
            }
