...
header("Content-disposition: attachment; filename=docIn_" . str_replace(" ", "_", $starts != $ends ? indo_date(date("Y-m-d", strtotime($starts))) . "-" . indo_date(date("Y-m-d", strtotime($ends))) : indo_date(date("Y-m-d", strtotime($starts)))) . ".xls");
...
<table border="1" style="width: 100%">
    <thead>
        <tr>
            ...
            <th class="text-center" style="width:140px">Receive from</th>
