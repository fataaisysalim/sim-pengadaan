<?php if($resource == 4) { ?>
    <table>
        <tr>
            <td style="width: 130px;"><b>Total Kontrak: </b></td>
...
<div id="kategori">
    <?php if(isset($invoice_wo)) { ?>
        ...
        <table>
            <tr><td>&nbsp;</td></tr>
            <tr>
                <td  style="width: 130px;"><b id="input_name">Nilai Uang Muka : </b></td>
                <td style="font-weight: bold">
                    <div class="row">
                        <div class="col-xs-7">
        ...
        <table>
            <tr>
                <td style="width: 130px;"><b>Angsuran Uang Muka : </b></td>
                <td style="font-weight: bold">
                    <div class="row">
                        <div class="col-xs-8">
                        ...
                        <div class="col-xs-3" id="um_percent">
                            <?php echo isset($invoice_wo) ? rupiah($invoice_wo->work_order_dp) . '%' : NULL; ?>
                        </div>
                    </div>
                </td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr>
                <td style="width: 130px;"><b>Retensi : </b></td>
                <td style="font-weight: bold">
                    <div class="row">
                        <div class="col-xs-8">
                        ...
                        <div id="retensi_percent" class="col-xs-3">
                            <?php echo isset($invoice_wo) ? rupiah($invoice_wo->work_order_retensi) . '%' : NULL; ?>
                        </div>
                </td>
            </tr>
            <tr><td>&nbsp;</td></tr>
...
<table>    
    <?php if($resource == 1) { ?>
        ...
        <tr>
            <td style="width: 130px;"><b>Total : </b></td>
            <td style="font-weight: bold">
                <input readonly class="form-control" type="text" style="font-weight: bold" name="invoice_total" id="invoice_total" value=""/>
            </td>
        </tr>
    <tr><td>&nbsp;</td></tr>
    <?php } ?>
    <tr>
        ...
        <td style="font-weight: bold">
            <?php if($resource == 2) { ?>
                <input class="form-control" type="hidden" style="font-weight: bold" name="invoice_total" id="invoice_total" value=""/>
            <?php } ?>
            <input <?php echo $resource == 4 ? 'readonly' : NULL; ?> class="form-control" onkeyup="netto_bruto(this)" type="text" style="font-weight: bold" name="invoice_netto" id="invoice_netto" value="<?php echo isset($invoice_id) ? rupiah($invoice->invoice_netto) : NULL; ?>"/>
        </td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
        ...
        <td style="font-weight: bold">
            ...
            <?php $tax['ppn'] = 0; foreach($invoice_tax as $t) : ?>
                ...
                <?php } ?>
            <?php endforeach; ?>
            <input class="form-control" type="text" style="font-weight: bold" name="ppn" id="ppn" value="<?php echo rupiah($tax['ppn']); ?>" readonly/>
            <?php } else { ?>
            <input class="form-control" type="text" style="font-weight: bold" name="ppn" id="ppn" value="" readonly/>
            <?php } ?>
        </td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
        ...
        <td style="font-weight: bold">
            <input readonly class="form-control" type="text" style="font-weight: bold" name="invoice_bruto" id="invoice_bruto" value=""/>
        </td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
        ...
        <td style="font-weight: bold">
            ...
            <?php $tax['pph'] = 0; foreach($invoice_tax as $t) : ?>
                ...
                <?php } ?>
            <?php endforeach; ?>
            <input class="form-control" type="text" style="font-weight: bold" name="pph" id="pph" value="<?php echo rupiah($tax['pph']); ?>" readonly/>
            <?php } else { ?>
            <input class="form-control" type="text" style="font-weight: bold" name="pph" id="pph" value="" readonly/>
            <?php } ?>
        </td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
        ...
        <td style="font-weight: bold">
            <input class="form-control" type="text" style="font-weight: bold" name="total" id="total" value="" readonly/>
        </td>
    </tr>
</table>
