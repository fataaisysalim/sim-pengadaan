...
$fpdf->tabelbb(array("NO. : $mogdet->mog_number","/ GD /      $mogdet->project_code","/ ","".  date('Y')), 0.5);
$fpdf->Ln(0.1);
$fpdf->SetWidths(array(2,6));
$fpdf->SetX(5);
$fpdf->tabelbb(array("Leveransir",": $mogdet->mog_number_letter"), 0.35);
$fpdf->SetX(5);
$fpdf->tabelbb(array("Surat Jalan",": "), 0.4);
$fpdf->SetX(5);
$fpdf->tabelbb(array("Tanggal",": ".  indo_date($mogdet->mog_date)), 0.35);
$fpdf->SetXY(13.3,2.7);
$fpdf->tabelbb(array("S.P.B",": "), 0.45);
$fpdf->SetX(13.3);
$fpdf->tabelBB(array("S.P.K",": "), 0.45);
$fpdf->SetXY(7.5,4);
$fpdf->SetFont("TIMES", "", 10);
$fpdf->Ln(0.2);
$fpdf->SetWidths(array(1,2.5,4.25,1,1,2.4,3,1.75,4));
$fpdf->SetFont("TIMES", "B", 8);
$fpdf->tabelc(array("No.","KODE S. DAYA","JENIS MATERIAL","SAT",'VOL',"H. SATUAN","JUMLAH","Stock Sisa","KETERANGAN"), 0.5);
...
$fpdf->tabelc(array(++$i,"$row->code_name","$row->material_sub_name","$row->material_unit_name","$volume","","",$row->stock_rest,"$row->mog_dt_note"), 0.4);
$toti += $i;
endforeach;
if($toti<=9){
    $f=9-$toti;
...
$y=$fpdf->GetY();
$fpdf->SetWidths(array(2.4,3));
$fpdf->SetX(9.95);
$fpdf->tabelbbr(array("JUMLAH","$mogdet->mog_total"), 0.4);
$fpdf->SetWidths(array(1.65));
$fpdf->SetXY(0.83,9.9);
$fpdf->tabelbb(array("CATATAN"), 0.4);
$fpdf->SetWidths(array(1.65,4));
$fpdf->tabelbb(array("1-5 & 8",": Di Isi Oleh Bag. Gudang"), 0.5);
$fpdf->tabelbb(array("6-7",": Di Isi Oleh Bag. KSPP"), 0.5);
$fpdf->Ln(0.2);
