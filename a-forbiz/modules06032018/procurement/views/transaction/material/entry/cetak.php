...
<section class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <div class="row" style="margin-top: -20px">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <div class="input-group mg-b-md">
                            <?php echo indo_date($row->tanggal_spb, 1, 1) ?>
                        </div>
                    </div>
                </div>
                <div class="col-xs-4">
        ...
        <section class="panel">
                        ...
                        <tbody id="show_row">
                           ...
                           foreach($mog_dt as $i => $row) { 
                            ...
                            <tr class="row_out row_tam">
                                ...
                                <td class="hidden-xs">
                                    <?php echo $row->mog_dt_convertion?>
                                </td>
                                <td>
            ...
            <div class="row"><center><input type="button" onclick="print_pengajuan()" value="Print"></center></div>
        </section>
    </div>
</section>
<?php echo form_close();?>
