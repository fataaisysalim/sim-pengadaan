                    ...
                    <div class="panel <?php echo $bg_kspp?> of-h mb10">
                        <div class="pn pl20 p5">
                            ...
                            <span class="badge badge-danger" style="color: #FFFFFF !important;">
                                ...
                                <?php 
                                    $sql = $this->db->query("SELECT * FROM mog where role_id='".$sess['users']->users_divisi."' AND tujuan='Approval KSPP'");
                                    echo $sql->num_rows();
                                ?>
                            </span>
                            <span class="badge_green" style="color: #FFFFFF !important;">
                    ...
                    <div class="panel <?php echo $bg_mp?> of-h mb10">
                        <div class="pn pl20 p5">
                            ...
                            <span class="badge badge-danger" style="color: #FFFFFF !important;">
                                ...
                                <?php 
                                    $sql = $this->db->query("SELECT * FROM mog where role_id='".$sess['users']->users_divisi."' AND tujuan='Approval MP'");
                                    echo $sql->num_rows();
                                ?>
                            </span>
                            <span class="badge_green" style="color: #FFFFFF !important;">
                    ...
                    <div class="panel <?php echo $bg_dan?> of-h mb10">
                        <div class="pn pl20 p5">
                            ...
                            <span class="badge badge-danger" style="color: #FFFFFF !important;">
                                ...
                                <?php 
                                    $sql = $this->db->query("SELECT * FROM mog where role_id='".$sess['users']->users_divisi."' AND tujuan='Approval M.DAN'");
                                    echo $sql->num_rows();
                                ?>
                            </span>
                            <span class="badge_green" style="color: #FFFFFF !important;">
                            <?php $sql = $this->db->query("SELECT jml_proses FROM master_user_role where id_user_role=13");
                            echo $sql->row()->jml_proses;
                            ?>
                            </span>
                        </div>
                    ...
                    <div class="panel <?php echo $bg_div?> of-h mb10">
                        <div class="pn pl20 p5">
                            ...
                            <span class="badge badge-danger" style="color: #FFFFFF !important;">
                                ...
                                <?php 
                                    $sql = $this->db->query("SELECT * FROM mog where role_id='".$sess['users']->users_divisi."' AND tujuan='Approval M.DIV'");
                                    echo $sql->num_rows();
                                ?>
                            </span>
                            <span class="badge_green" style="color: #FFFFFF !important;">
                            <?php $sql = $this->db->query("SELECT jml_proses FROM master_user_role where id_user_role=7");
                            echo $sql->row()->jml_proses;
                            ?>
                            </span>
                        </div>
                    ...
                    <div class="panel <?php echo $bg_dir?> of-h mb10">
                        <div class="pn pl20 p5">
                            ...
                            <span class="badge badge-danger" style="color: #FFFFFF !important;">
                                ...
                                <?php 
                                    $sql = $this->db->query("SELECT * FROM mog where role_id='".$sess['users']->users_divisi."' AND tujuan='Approval Direksi'");
                                    echo $sql->num_rows();
                                ?>
                            </span>
                            <span class="badge_green" style="color: #FFFFFF !important;">
                            <?php $sql = $this->db->query("SELECT jml_proses FROM master_user_role where id_user_role=10");
                            echo $sql->row()->jml_proses;
                            ?>
                            </span>
                        </div>
