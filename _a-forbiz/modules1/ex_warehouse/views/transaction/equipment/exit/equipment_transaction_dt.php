<?php
$counter = 0;
foreach ($equipt_trans_dt as $i => $row) {
    ?>
    <?php $no = $i + 1; ?>
    ...
    <td class="text-center">
        ...
        <input type="hidden" id="stok_<?php echo $no; ?>" class=" form-control " value="<?php echo $row->equipment_stock_final_rest >= $row->equipt_transaction_dt_volume ? $row->equipment_stock_final_rest : $row->equipt_transaction_dt_volume; ?>" class="form-control" placeholder="Price">
