        ...
        <div class="row" style="margin-top: -20px">
                ...
                <div class="col-xs-5">
                    <div class="form-group">
                        ...
                        <div class="input-group mg-b-md">
                            ...
                            <input type="text" name="mog_project_code" value="<?php echo isset($mog_dt) ? $mog_dt->project_code : NULL; ?>" class="proCode form-control" placeholder="Project Code" readonly>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6">
                    <div class="form-group">
                        ...
                        <div class="input-group mg-b-md">
                            ...
                            <input type="text" name="mog_number" value="<?php echo empty($mog_dt) ? set_value('mog_number') : $mog_dt->mog_number; ?>" class="form-control" placeholder="BAPB Number">
                        </div>
                    </div>
                </div>
                <div class="col-xs-6">
                    <div class="form-group">
                        ...
                        <div class="input-group mg-b-md">
                            ...
                            <input type="text" name="mog_number_letter" class="form-control" value="<?php echo isset($mog_dt) ? $mog_dt->mog_number_letter : NULL; ?>" placeholder="Travel Document"/>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xs-7">
                <div class="col-xs-12 mg-t-lg">
                    <div class="form-group">
                        <label class="col-xs-6 text-right mg-t-sm">BAPB Date</label>
                        <div class="col-xs-6">
						<div class="row">
                        ...
                        <thead class="bg-dark" style="color: white">
                            <tr>
                                ...
                                <?php if ($permit->access_special == 1) { ?>
                                    <th class="text-center" style="width: 150px; padding: 15px">Code</th>
                                <?php } ?>
                                ...
                                <th class="text-center" style="width: 150px; padding: 15px">Convertion</th>
