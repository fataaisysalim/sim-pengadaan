                ...
                <div class="row">
                    <div class="col-sm-12" style="margin-right: 5px; margin-left: 5px;">
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="30" class="form-control" placeholder="Description Max 30 Character " name="invoice_note" value="<?php echo isset($invoice_id) ? $invoice->invoice_note : NULL; ?>"/>
                        </div>
                    </div>
                </div>
