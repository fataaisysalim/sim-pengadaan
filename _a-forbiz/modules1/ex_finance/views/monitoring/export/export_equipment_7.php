        ...
        <?php foreach ($array as $arri => $rowi) : ?>
            <tr>
                ...
                <?php foreach ($rowi['equipment_stock_detail'] as $di => $rodi) : ?>
                    ...
                    <?php $total_body[$arri][] = $rodi['equipment_subtotal']; ?> 
                <?php endforeach; ?>
            </tr>
        <?php endforeach; ?>
    </tbody>
    <tfoot>
        ...
        <tr>
            ...
            <?php foreach ($head as $indexhead => $rowhead) : ?>
                ...
                <td></td>
                <td></td>
                <!--<td style="vertical-align: middle; text-align: right;"><?php echo number_format(array_sum($total_body[$tf]), 0, '', '.'); ?></td>-->
                <?php $tf++; ?>
            <?php endforeach; ?>
        </tr>
    </tfoot>
