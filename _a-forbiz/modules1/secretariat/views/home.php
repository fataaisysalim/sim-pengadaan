    ...
    <div class="col-xs-12">
        <div class="col-md-7">
            <section class="panel panel-info row">
                <div class="panel-heading"><i class="fa fa-signal mg-r-sm"></i>Average Transaction Documents</div>
        ...
        <div class="col-md-5">
            <div class="row">
                ...
                <section class="col-xs-12">
                    <h5><b><i class="fa fa-clock-o mg-r-sm"></i>Secretariat Activity</b></h5>
...
<script>
    setTimeout(function () {
        ...
        toastr.info('You are currently access Secreatariat Modul', 'Welcome to WG System');
    }, 500);
    loadgraph();
    function loadgraph(){
        $("#graphaverage").load('<?php echo base_url() ?>secretariat/index/transaverage/'+$('select[name=yearload] option:selected').val()+"/"+$('select[name=projectload] option:selected').val());
    };
</script>
