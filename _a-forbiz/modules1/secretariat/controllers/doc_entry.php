...
class Doc_entry extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view("secretariat/info/entry/index", $data);
    }
    ...
    public function data($project = null, $start = null, $end = null, $code = null) {
        ...
        $this->load->view("secretariat/info/entry/data", $data);
    }
    ...
    public function export($project = null, $start = null, $end = null, $code = null) {
        ...
        $this->recActivity("Exported <b>Document Entry ($data[starts] - $data[ends])</b>", "secretariat");
        $this->load->view("secretariat/info/entry/export", $data);
    }
    ...
    public function detail($project = null, $start = null, $end = null, $code = null) {
        ...
        $this->load->view("secretariat/info/entry/detail", $data);
    }
