...
<section class="panel panel-info">
    <header class="panel-heading lead">
        <i class='fa fa-edit mg-r-sm'></i> Form Pengadaan Material
    </header>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mg-b-md">
                               <input type="text" name="mog_number_letter" class="form-control" placeholder="" style="width:100%"/>
                            </div>
                        </div>
                    </div>
                <div class="col-xs-6">
                    <div class="form-group">
                        <label>Status</label>
                        <div class="input-group mg-b-md">
                         <input type="text" name="mog_number_letter" class="form-control" placeholder="" disabled />
						</div>
                    </div>
                </div>
                <div class="col-xs-6">
                    <div class="form-group">
                        ...
                        <div class="input-group mg-b-md">
                            ...
                            <input readonly type="text" name="mog_number_letter" class="form-control" placeholder="Tanggal Pengiriman"/>
			...
			<div class="col-sm-5">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="input-group mg-b-md">
                         <input type="text" name="mog_number_letter" class="form-control" placeholder=""  />
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        <label>&nbsp;</label>
                        <div class="input-group mg-b-md">
                        <input type="radio" name="pkp" value="PKP">PKP
					   </div>
                    </div>
                </div>
                <div class="col-xs-6">
                    <div class="form-group">
                        <label>&nbsp;</label>
                        <div class="input-group mg-b-md">
                        <input type="radio" name="pkp" value="PKP">Non PKP
					   </div>
                    </div>
                </div>
				<div class="col-xs-6">
                    <div class="form-group">
                        <label>Upload SPB</label>
                        <div class="input-group mg-b-md">
                         <input type="file" name="mog_number_letter" class="form-control" placeholder="" />
						</div>
                    </div>
                </div>
            </div>  
        ...
        <section class="panel">
            <div class="panel-body row">
				...
				<a href="<?php echo base_url();?>procurement/transaction/material/tambah" class="btn btn-primary pull-right" style="margin-bottom:10px">Buat SPB Baru</a>
                    <table class="table table-bordered table-striped" style="margin-top: -13px">
                        <thead class="bg-dark" style="color: white">
                            <tr>
                                ...
                                <th class="text-center" style="width: 250px; padding: 15px">Uraian Barang</th>
                                <th class="text-center" style="width: 250px; padding: 15px">Kode Sumberdaya</th>
                                <th class="text-center" style="width: 250px; padding: 15px">Volume</th>
                                <th class="text-center" style="width: 250px; padding: 15px">Satuan</th>
                                <th class="text-center" style="width: 250px; padding: 15px">Harga Satuan</th>
                                <th class="text-center" style="width: 250px; padding: 15px">Jumlah</th>
                                <th class="text-center" style="width: 250px; padding: 15px">Keterangan</th>
                            </tr>
                        </thead>
                        <tbody id="">
						<tr>
							<td>1</td>
							<td><input type="text" name="mog_number_letter" class="form-control" placeholder=""  /></td>
							<td><input type="text" name="mog_number_letter" class="form-control" placeholder=""  disabled /></td>
							<td><input type="text" name="mog_number_letter" class="form-control" placeholder=""  /></td>
							<td><input type="text" name="mog_number_letter" class="form-control" placeholder=""  /></td>
							<td><input type="text" name="mog_number_letter" class="form-control" placeholder=""  /></td>
							<td><input type="text" name="mog_number_letter" class="form-control" placeholder=""  /></td>
					...
					<button class="btn btn-info btn-block"><i class="fa fa-plus"></i></button><br>
