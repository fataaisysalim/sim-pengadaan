<?php if ($sess['position_id'] == 1 OR $sess['position_id'] == 4 OR $sess['position_id'] == 5 OR isset($mog_id)) { ?>
    ...
    <script type="text/javascript">
        $(".load_main_data").load("<?php echo base_url() . $url_access . 'form/' ?><?php echo isset($mog_id) ? $mog_id : NULL; ?>");
    </script>
<?php } else { ?>
    <h1 class="pull-left mg-t-sm"><i class="fa fa-warning mg-r-sm"></i></h1><h3><small>Mohon maaf anda tidak berhak mengakses fitur</small><br/> <b>Material Receipt</b></h3>
    <?php } ?>
