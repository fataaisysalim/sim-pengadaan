...
<!--    <td>
    ...
    <td class="hidden-xs">
        <input type="text" id="mog_dt_unit_<?php echo $no; ?>" name="unit[]" value="<?php echo isset($row->material_unit_name) ? $row->material_unit_name : NULL; ?>" class="form-control" placeholder="Satuan" readonly>
    </td>
    <td>
        <input <?php echo $sess['position_id'] == 1 ? NULL : 'readonly'; ?> id="mog_dt_volume_<?php echo $no; ?>" class=" form-control " onkeyup="get_count(this, <?php echo $no; ?>, 'volume')" name="mog_dt_volume[]" value="<?php echo rupiah($row->mog_dt_volume); ?>" class="form-control" placeholder="Volume">
    </td>
    <td>
    ...
    <td class="text-center">
        ...
        <input type="hidden" id="stock_final_rest_<?php echo $no; ?>" class=" form-control " name="stock_final_rest[]" value="<?php echo $row->stock_final_rest; ?>" class="form-control" placeholder="Price">
