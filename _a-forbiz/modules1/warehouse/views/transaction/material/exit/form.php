        ...
        <div class="row" style="margin-top: -20px">
            <div class="col-sm-7">
                ...
                <div class="col-xs-5">
                    <div class="form-group">
                        ...
                        <div class="input-group mg-b-md">
                            ...
                            <input type="text" name="mog_project_code" value="<?php echo isset($mog) ? $mog->project_code : NULL; ?>" class="proCode form-control" placeholder="Kode SPK" readonly>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6">
                    <div class="form-group">
                        <label>Nomor BPM</label>
                        <div class="input-group mg-b-md">
                            <span class="input-group-addon"><i class="fa fa-bookmark"></i></span>
                            <input type="text" name="mog_number" value="<?php echo empty($mog) ? set_value('mog_number') : $mog->mog_number; ?>" class="form-control" placeholder="Nomor BPM">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-5 mg-b-sm">
                    <div class="form-group">
                        <label>Pemakai</label>
                        <select id="actor" name="actor" onchange="getActData()" class="form-control form-select2" data-style="btn-white" data-placeholder="Pilih Foreman/Subcon">
                            <option value=""></option>
                    ...
                    <div class="col-xs-6 mg-b-md">
                        <div class="form-group">
                            ...
                            <div class="input-group mg-b-md">
                                ...
                                <input type="text" class="codeAct form-control" value="<?php echo isset($mog) ? $mog->actor_code : NULL; ?>" placeholder="Kode Nasabah" readonly/>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 mg-b-md">
                        <div class="form-group">
                            ...
                            <input type="text" class="npwpAct form-control" value="<?php echo isset($mog) ? $mog->actor_identity : NULL; ?>" placeholder="Nomor Identitas" readonly/>
                        </div>
                    </div>
            </div>
            <div class="col-xs-5">
                <div class="col-xs-12 mg-t-lg">
                    <div class="form-group">
                        <label class="col-xs-6 text-right">Tanggal BPM</label>
                        <div class="col-xs-6">
                    ...
                    <table class="table table-bordered table-striped" style="margin-bottom: 0px">
                        <thead class="bg-dark" style="color: white">
                            <tr>
                                ...
                                <th class="text-center" style="min-width: 250px; padding: 15px">Material</th>
                                ...
                                <th class="text-center" style="width: 140px; padding: 15px">Tahap Pekerjaan</th>
                                <th class="text-center" style="width: 200px; padding: 15px">Keterangan</th>
...
<?php } ?>
    ...
    + '<input type="hidden" name="mog_dt[]" value="">'
            ...
            + '<td>'
            + '<input id="mog_dt_note_' + counter + '" class=" form-control " name="mog_dt_note[]" value="" class="form-control" placeholder="Tahap Pekerjaan">'
            + '</td>'
            + '<td>'
            + '<input id="mog_dt_note_' + counter + '" class=" form-control " name="mog_dt_note[]" value="" class="form-control" placeholder="Keterangan">'
            + '</td>'
