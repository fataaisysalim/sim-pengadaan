            ...
            <div class="col-sm-7">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <div class="input-group mg-b-md">
                            ...
                            <input type="text" name="mog_number" value="<?php echo empty($mog_dt) ? set_value('mog_number') : $mog_dt->mog_number; ?>" class="form-control" placeholder="Nomor BAPB">
                        </div>
                    </div>
                </div>
                <div class="col-xs-4">
                ...
                <div class="">
                    <div class="col-xs-5 mg-b-md">
                        <div class="form-group">
                            ...
                            <div class="input-group mg-b-md">
                                ...
                                <input type="text" id="kode_nasabah" class="codeAct form-control" value="<?php echo isset($mog_dt) ? $mog_dt->actor_code : NULL; ?>" placeholder="Kode Nasabah" readonly/>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-7 mg-b-md">
                        <div class="form-group">
                            <label>NPWP</label>
                            <input type="text" id="npwp" class="npwpAct form-control" value="<?php echo isset($mog_dt) ? $mog_dt->actor_identity : NULL; ?>" placeholder="NPWP" readonly/>
                        </div>
                    </div>
                </div>
            </div>
		...
		$.ajax({
			...
			success: function(data) {
				...
				for(var i=0;i<data.length; i++){
					options += "<option data-kode='"+data[i].kode+"' data-npwp='"+data[i].npwp+"' value='"+data[i].id+"'>"+ data[i].nama +"</option>"; 
				}
