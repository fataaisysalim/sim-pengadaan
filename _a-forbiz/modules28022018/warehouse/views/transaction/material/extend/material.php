<div class="form-group">
    <select id="material_<?php echo $count ?>" onchange="get_unit('<?php echo $count ?>')" name="material[]" class="form-control form-select2" data-style="btn-white" data-placeholder="Pilih Material">
