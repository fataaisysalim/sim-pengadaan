...
class Bapb extends MY_Controller {

    private $title = "Material Receipt";
    private $url = "warehouse/bapb/";
    ...
    public function index($id = null) {
        ...
        $data['content'] = "warehouse/transaction/material/entry/index";
    ...
    public function form($id = NULL) {
        ...
        $this->load->view("warehouse/transaction/material/entry/form", $data);
    }
