        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <a role="button" onclick="disposition()" class="pull-right hidden-xs btn btn-sm mg-l-sm btn-warning" style="margin-top:-5px"><i class="fa fa-print mg-r-sm"></i> Print Disposition</a>
...
<script type="text/javascript">
    $(".modal-title").html('<a role="button" onclick="backDocEx()" class="pull-left btn btn-sm btn-danger" style="margin-top:-5px"><i class="fa fa-reply"></i></a><i class="fa fa-search mg-r-md"></i>Detail Document In');     
    function disposition(){
        window.open("<?php echo base_url() ?>secretariat/doc-control/disposition/<?php echo md5($doc['control']->doc_control_id); ?>");
    }
    
    function backDocEx() {
        $(".modal-title").html('<div class="loader mg-t"><i class="fa fa-spin fa-refresh mg-r-md"></i>Loading data. Please wait...');
        $("#modal-contents").html('');
        $("#modal-contents").load("<?php echo base_url() ?>secretariat/doc_entry");
