    ...
    <table class="table table-bordered table-striped datatable">
        <thead class="bg-dark" style="color: white;">
            <tr>
                ...
                <th class="text-center" style="min-width:150px">Receive from</th>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class=" btn-group btn-group-justified">
                            ...
                            <a role="button" title="Print Disposition" onclick="disposition('<?php echo md5($rox->doc_control_id); ?>')" class="btn btn-xs btn-dark"><i class="fa fa-print"></i></a>
...
<script>
    function disposition(id){
        window.open("<?php echo base_url() ?>secretariat/doc-control/disposition/"+id);
    }
