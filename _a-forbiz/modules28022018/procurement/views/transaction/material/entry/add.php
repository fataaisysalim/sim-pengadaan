    ...
    <div class="panel-body">
        ...
        <div class="row" style="margin-top: -20px">
                ...
                <div class="col-xs-3">
                    <div class="form-group">
                        ...
                        <div class="input-group mg-b-md">
                            <input type="text" class="datepicker" name="tanggal" id="tanggal" value="<?php echo isset($row->tanggal_spb) ? $row->tanggal_spb : NULL; ?>">
                        </div>
                    </div>
                </div>
                <div class="col-xs-3">
                    <div class="form-group">
                        ...
                        <div class="input-group mg-b-md">
                        <input class="pengajuan" type="radio" name="jenis" id="jenis_pengajuan" value="pengajuan" checked> Pengajuan
                        <input class="pengadaan" type="radio" name="jenis" id="jenis_pengadaan" value="pengadaan"> Pengadaan
                         <!-- <select class="">
                                <option>- Open -</option>
                                <option>- Close -</option>
                         </select> -->
            ...
            <div class="pengajuan_tampil">
                    ...
                    <?php if($sess['users']->users_divisi == 16 || $sess['users']->users_divisi == 17): ?>
                     <div class="col-xs-3 mg-b-md">
                        <div class="form-group">
                            <label>No SPB</label>
                            <div class="input-group mg-b-md">
            ...
            function adds_row() {
              ...
              /*$.ajax({
                ...
                function approved(){
                    ...
                    if(spb==""){
                        bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>No SPB harus diisi");
                        $("#no_spb").focus();
                        return false;
                        ...
                        bootbox.alert("<i class='fa fa-warning mg-r-sm'></i>No BAPB harus diisi");
                        $("#no_spb").focus();
                        return false;
                    <?php } 
                        endif;?>
