...
<section class="panel panel-info">
    ...
    <!--     <div class="form-group">  
                 ...
                 <div class="row">
                    <div class="col-xs-3">
                        ...
                        <div class="input-group mg-b-md">
                            <input type="radio" name="jenis" value="pengajuan" checked> Pengajuan
                            <input type="radio" name="jenis" value="pengadaan"> Pengadaan
                         </div>
                        </div>
                    </div>
            ...
            <div class="col-xs-1">
                <div class="form-group">
                <label>&nbsp;<span style="color:white">Tom</span></label>
                    <a href="<?php echo base_url()?>procurement/transaction/material/tambah" id="save_btn" class="btn btn-primary"><i class="fa fa-plus mg-r-sm"></i> Buat Baru <span class="buat_pengajuan">Pengajuan</span></a>
                </div>
            </div>
            <?php endif;?>
        </div>
                ...
                <table class="table table-bordered table-striped datatable" style="margin-top: -13px">
                    ...
                    <tbody id="filterTabs">
                       ...
                       <tr>
                        ...
                        <td class="text-center" style="width: 250px; padding: 15px">
                            <a class="btn btn-success" href="<?php echo base_url() ?>procurement/transaction/material/tambah/<?php echo $row->mog_id?>/view"><i class="fa fa-edit"></i><?php echo $view?></a>
                            <?php 
                            if($sess['users']->users_divisi == 17 || $sess['users']->users_divisi == 15 || $sess['users']->users_divisi == 20 || $sess['users']->users_divisi == 19 || $sess['users']->users_divisi == 18)
                            {
                            }else{
                            ?>
