...
$fpdf->SetX(5.5);
$fpdf->tabelbb(array(" PROYEK $mogdet->project_name"), 0.5);
...
$fpdf->tabelbb(array("NO. : $mogdet->mog_number","/ $mogdet->project_code","/ BPM    /","".  date('Y')), 0.5);
...
$fpdf->tabelc(array("No","Nama Barang","Kode Tahap Pekerjaan","Kode Sumber Daya","Sat","Volume","Keterangan"), 0.45);
...
foreach($mog as $i=>$row):
    ...
    $fpdf->SetWidths(array(1.1,5.6,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,1,2.5,2.9));
$fpdf->tabelcontent(array(++$i,"$row->material_sub_name","","","","","","","","","","","$row->material_unit_name","$row->mog_dt_volume","$row->mog_dt_note"), 0.5);
//$y=$fpdf->GetY();
