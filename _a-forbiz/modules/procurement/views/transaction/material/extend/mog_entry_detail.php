...
<tr class="row_out row_tam">
    ...
    <td>
        <div class="form-group">
            <!-- <select id="code_<?php echo $no; ?>" name="code[]" class="form-control selectpicker" data-style="btn-white">
             ...
             <input id="code_<?php echo $no; ?>" type="text" name="uraian[]" value="<?php echo $row->code_id; ?>" class="form-control">
        </div>
    </td>
    <?php //} ?>
    ...
    <td>
        <input id="mog_dt_volume_<?php echo $no; ?>" class=" form-control " onkeyup="get_count(this, <?php echo $no; ?>, 'volume')" name="mog_dt_volume[]" value="<?php echo rupiah($row->mog_dt_volume); ?>" class="form-control" placeholder="Volume">
    </td>
	<?php if($role_id!=15) { ?>
    <?php //if($mog_status != 0 || $sess['position_id'] == 5) { ?>
    <td>
        <input id="mog_dt_price_<?php echo $no; ?>" class=" form-control " onkeyup="get_count(this, <?php echo $no; ?>, 'price')" name="mog_dt_price[]" value="<?php echo isset($row->mog_dt_price) ? rupiah($row->mog_dt_price) : NULL; ?>" class="form-control" placeholder="Price" required>
    </td>
